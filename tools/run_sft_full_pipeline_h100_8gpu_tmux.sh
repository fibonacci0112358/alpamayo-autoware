...
STAGE1_OUTPUT_BASE="/mnt/nvme/alpamayo_outputs/stage1_vlm_full_folders_h100_8gpu_pipeline"
STAGE2_OUTPUT_BASE="/mnt/nvme/alpamayo_outputs/stage2_h100_8gpu_full_folders_pipeline"
...
PIPELINE_SESSION_NAME="alpamayo-sft-full-pipeline-${RUN_ID}"
DEEPSPEED_CONFIG="finetune/sft/configs/deepspeed/zero2.json"
STAGE2_CONFIG_NAME="stage2_h100_8gpu_full_folders"

STAGE1_OUTPUT_DIR="${STAGE1_OUTPUT_BASE}_$RUN_ID"
STAGE2_OUTPUT_DIR="${STAGE2_OUTPUT_BASE}_$RUN_ID"
...
log_main "[pipeline] Creating/updating symlink: $STAGE1_OUTPUT_BASE -> $STAGE1_OUTPUT_DIR"
ln -sfnT "$STAGE1_OUTPUT_DIR" "$STAGE1_OUTPUT_BASE"
...
log_main "[pipeline] Creating/updating symlink: $STAGE2_OUTPUT_BASE -> $STAGE2_OUTPUT_DIR"
ln -sfnT "$STAGE2_OUTPUT_DIR" "$STAGE2_OUTPUT_BASE"
...
STAGE1_OUTPUT_DIR="${STAGE1_OUTPUT_BASE}_$RUN_TS"
STAGE2_OUTPUT_DIR="${STAGE2_OUTPUT_BASE}_$RUN_TS"
